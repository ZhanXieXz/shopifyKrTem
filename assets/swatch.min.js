  ...
  function updateGroupVariant(t, e, a, i, o) {
      if (use_vimg && "#cart-form_qs" != t) {
          ...
          if ("_qv" == i && (n += "_qv"), $(n + ' [data-grname="not4"]').length != $(n + " [data-grname]").length && 0 != $(n + ' [data-grname="' + e + '"]').length) {
              ...
              if ($(n + " .js-sl-item," + s + " .js-sl-item").addClass("is_varhide"), $(n + ' [data-grname="opnt4"], ' + n + ' [data-grname="' + e + '"][data-grpvl="' + a + '"],' + s + ' [data-grname="opnt4"],' + s + ' [data-grname="' + e + '"][data-grpvl="' + a + '"]').removeClass("is_varhide"), "#cart-form_ppr" == t && 0 < $(".p-thumb.isotope_ok").length) $(".last_visible").removeClass("last_visible"), $(".js-sl-item:visible:last").addClass("last_visible"), $(".p-thumb.isotope_ok").isotope();
              else {
                  var r = JSON.parse($(n + ".flickity-enabled").attr("data-flickity") || "{}"),
                      c = JSON.parse($(s + ".flickity-enabled").attr("data-flickityjs") || "{}");
                  $(n + ".flickity-enabled").flickity("destroy").flickity(r), $(s + ".flickity-enabled").flickity("destroy").flickity(c).removeClass("p-nav-ready"), $(str_qv).scrollTop(qvscrollTop), setTimeout(function() {
  ...
  geckoShopify.Ntproduct_switch = function(t, n, e, k, w, b, S, C) {
      ...
      if ($(b + "1 .nt-swatch").each(function(t) {
              ...
              if (e.parent().find(".is-selected").removeClass("is-selected"), e.parent().find(".is-selected-nt").removeClass("is-selected-nt"), e.addClass("is-selected"), i.find(".nt_name_current").addClass("user_choose_js").html(e.data("escape")).css("color", ""), $(".nt_lt_fake.opended").removeClass("opended"), !($(S + " .variations .nt-swatch.is-selected").length < q)) {
                  switch (U++, T.find(".js_frm_cart").removeClass("disabled").removeAttr("disabled"), geckoShopify.HideNotices(), q) {
                      ...
                      case 3:
                          ...
                          if (n.val(d.id), I) {
                              ...
                              var m, g, y = getVariantFromSize(2, M, j, c, l),
                  ...
                  d.featured_media && (x = d.featured_media.id), qvscrollTop = $(str_qv).scrollTop(), updateGroupVariant(k, o, a, C, x), s != n.val() && selectCallback(d, k, w, q, S, b, C, O, r, pr_incoming_mess, use_notify_me, save_js, enableHistoryState)
              }
          }), use_clicking_vimg) {
      ...
      if (body.hasClass("template-cart")) {
          ...
          fetch(cartUrl + "?view=pagejs", {
              ...
              if (i != a) {
                  ...
                  var o = e[1].split(",]"),
                      n = $(".cart_thres_" + o[0]);
                  "spt4" != o && (n.is(":hidden") && ($(".cart_thres_1,.cart_thres_2,.cart_thres_3").slideUp(200), n.slideDown(250)), ck_canvas = !(0 == i || !$(".cart_thres_3").is(":hidden")), UpdateShipBar(e[1], o[1], n)), r && $(".js_cat_items").html(e[2]), $(".js_cat_dics").html(e[3]), $(".js_cat_ttprice").html(e[4]), "1" == e[5] ? $(".js_gift_wrap").addClass("dn") : $(".js_gift_wrap").removeClass("dn"), body.trigger("refresh_currency"), $.magnificPopup.instance.isOpen && $.magnificPopup.close()
              }
              $(".nt_js_cart.loading, .js_addtc.loading, .js_frm_cart.loading, .js_add_group.loading, .sticky_atc_js.loading").removeClass("loading"), $ld.trigger("ld_bar_end"), r && $("html, body").animate({
  ...
  geckoShopify.AgreeCheckout = function() {
      ...
      if (0 != t.length) {
          ...
          var r = function(t, e, a, i) {
              $.magnificPopup.open({
                  items: {
                      src: '<div class="mfp-with-anim white-popup ajax_pp_popup ' + e + '">' + product_Modal_html + t + "</div>",
                      type: "inline"
                  },
                  removalDelay: 500,
                  callbacks: {
